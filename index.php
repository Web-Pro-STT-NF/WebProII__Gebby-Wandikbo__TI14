        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
              <div class="container border mt-3 shadow-sm mb-5 bg-body rounded shadow-lg  bg-body rounded">
                  <div class="row">
                    <div class="col text-center bg-dark text-light p-3">
                      <h3>BMI</h3>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-8">
                    <form class="p-5" method="POST" action="hasil.php"> 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-8">
                          ...
                          <span id="beratHelpBlock" class="form-text text-muted">Masuka dalam satuan (cm)</span>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-8">
                          ...
                          <span id="tinggiHelpBlock" class="form-text text-muted">Masuka dalam satuan (kg)</span>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="row">
                    <div class="col text-center bg-dark text-light pt-3">
                      <p><i>Created By <b>Gebby Wandikbo</b></i></p>
                    </div>
                  </div>
                </div>
              </div>
